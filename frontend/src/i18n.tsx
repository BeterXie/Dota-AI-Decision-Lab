...
const messages = {
  en: {
    ...
    pendingIdentityDescription: "Market data and team history prewarm are available. Verified map identity is still required for the current roster, draft and live decision modes.",
  ...
  "zh-CN": {
    ...
    pendingIdentityDescription: "市场数据与队伍历史预热已开始；当前上场阵容、选人和实时决策仍需确认地图身份。",
