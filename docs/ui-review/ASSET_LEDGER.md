# UI review asset ledger

| Asset | Role | Placement | Source / rights status | Rule |
| --- | --- | --- | --- | --- |
| `frontend/public/assets/heroes/home-hero-aegis.webp` | approved base/hero | Home hero | Owner-supplied prepared asset | Keep the Aegis on the right and preserve the left reading zone. |
| `frontend/public/assets/heroes/event-ti15-hero.webp` | approved base/hero | TI event hero | Owner-supplied prepared asset | Keep the Aegis on the left and event information readable on the right. |
| `frontend/public/assets/heroes/performance-hero.webp` | approved base/hero | AI performance intro | Owner-supplied prepared asset | Keep stage/shield detail on the right and the title on the left. |
| `image-gen-1.png` to `image-gen-3.png` | reference | Not placed | Owner-provided design references | Learn hierarchy and composition only. |
