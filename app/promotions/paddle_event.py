...
class PaddleEventPassService(PaddleCompetitionPassService):
    def __init__(
        self,
...
EventPassCheckoutConflict = CompetitionPassCheckoutConflict
EventPassWebhookResult = CompetitionPassWebhookResult
